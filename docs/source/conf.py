...
# -*- coding: utf-8 -*-
#
# GUNC documentation build configuration file, created by
...
html_logo = '../../GUNC_LOGO.png'
html_favicon = '../../GUNC_favicon.jpeg'
